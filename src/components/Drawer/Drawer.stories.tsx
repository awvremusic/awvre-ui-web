...
const TestContainer = (props) => {
  return <div style={{ height: 400 }}>{props.children}</div>;
};
...
export const Primary = (args) => <ArrangedApp {...args} />;
...
export const Left = (args) => <ArrangedApp {...args} />;
...
export const Top = (args) => <ArrangedApp {...args} />;
...
export const Bottom = (args) => <ArrangedApp {...args} />;
